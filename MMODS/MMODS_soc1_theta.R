...
source("COVID_pomp_gammabeta_theta.R")
...
saveRDS(
  ...
  , param_array      = param_array
     ...
     paste("output/"
       , paste(focal.county, fit_to_sip, more.params.uncer, fit.minus, Sys.Date(), "cont", "temp_MMODS_theta", sep = "_")
         , sep = "")
     , "Rds", sep = "."))
...
saveRDS(
  ...
  , param_array      = param_array
     ...
     paste("output/"
       , paste(focal.county, fit_to_sip, more.params.uncer, fit.minus, Sys.Date(), "cont", "final_MMODS_theta", sep = "_")
         , sep = "")
     , "Rds", sep = "."))
